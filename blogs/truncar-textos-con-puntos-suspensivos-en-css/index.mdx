...
##### [**white-space**](https://cssreference.io/property/white-space/)
...
##### [**overflow**](https://cssreference.io/property/overflow/)
...
##### [**text-overflow**](https://cssreference.io/property/text-overflow/)
...
<div className="dark:text-white" style={{ padding: '0px 30px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
  <strong>
    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
    when an unknown printer took a galley of type and scrambled it to make a type 
