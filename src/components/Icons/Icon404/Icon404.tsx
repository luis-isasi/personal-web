...
const Icon404: React.FC<React.SVGAttributes<SVGElement>> = (
  props: React.SVGProps<SVGSVGElement>
) => {
  return (
    <div className="relative bg-transparent h-full w-full">
      <svg
        id="prefix__astronaut"
        className={`${style.astronaut} absolute w-11 h-11 right-16 top-24 sm:right-20 sm:top-30`}
      ...
      >
        <style>
          {
            '.prefix__st1{fill:#504e55}.prefix__st3{fill:#fff}.prefix__st4{opacity:.24}.prefix__st5{fill:#77574e}.prefix__st10{opacity:.28}.prefix__st13{fill:#dae7be}.prefix__st15{fill:#5f5e60}'
          }
        </style>
        ...
        <path
          ...
          className="prefix__st10 prefix__st5"
        />
        <path
        ...
        <path
          ...
          opacity={0.25}
        />
        <path d="M371.6 128.9l25.1-23.8" className="prefix__st13" />
        <path
          ...
          className="prefix__st1"
        />
        <path d="M139.7 128.9l-25.1-23.8" className="prefix__st13" />
        <path
          ...
          className="prefix__st1"
        />
        <circle cx={114.6} cy={105.1} r={4.8} fill="#ffe0a6" />
        <path
        ...
        />
        <circle cx={396.7} cy={105.1} r={4.8} fill="#cfe1af" />
        <path
          ...
          className="prefix__st15"
        />
        <path d="M351.9 478.1H376M138 478.1h-18.3" className="prefix__st3" />
        <path
      ...
      >
        <circle
          className={`prefix__saturn ${style.saturn}`}
          cx={256}
          cy={256}
          r={149.536}
          fill="#FF4F54"
        ...
        <path
          className={`prefix__saturn ${style.saturn}`}
          d="M109.388 285.56c42.515 1.428 157.943-2.613 289.462-73.807a150.243 150.243 0 00-23.322-45.604c-42.716 29.386-140.403 83.922-268.457 76.27a148.502 148.502 0 002.318 43.14zm291.346 8.027c3.976-15.31 5.422-30.68 4.614-45.672-33.75 25.31-137.237 92.367-277.65 84.876a150.107 150.107 0 0023.472 29.88c44.354.286 137.696-6.443 245.93-57.163 1.362-3.89 2.58-7.86 3.634-11.92zM245.488 405.184c35.427 2.537 69.784-7.742 97.543-27.59-27.972 11.533-60.787 21.76-97.542 27.59zM348.02 138.097c-15.645-12.225-33.99-21.522-54.434-26.832-71.883-18.667-145.126 18.253-174.25 84.01 49.02-1.676 133.073-12.256 228.685-57.178z"
          fill="#EA4753"
        />
        <circle
          className={`prefix__hover ${style.hover}`}
          cx={319.166}
          cy={208.081}
          r={28.389}
          fill="#D83A4E"
        />
        <path
          d="M331.25 189.492a28.248 28.248 0 0114.792 9.452c-2.98-8.73-10.143-15.848-19.74-18.34-15.175-3.94-30.672 5.167-34.613 20.342-2.373 9.136-.012 18.384 5.55 25.162a28.261 28.261 0 01-.602-16.273c3.94-15.177 19.438-24.284 34.613-20.343z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M242.703 261.303a19.273 19.273 0 0110.085 6.444c-2.03-5.953-6.916-10.806-13.46-12.505-10.347-2.687-20.914 3.523-23.6 13.87-1.62 6.23-.008 12.537 3.785 17.158a19.265 19.265 0 01-.41-11.097c2.686-10.348 13.252-16.558 23.6-13.87z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M312.85 135.967a12.522 12.522 0 016.557 4.19c-1.32-3.872-4.496-7.026-8.75-8.13-6.727-1.747-13.596 2.29-15.343 9.017a12.563 12.563 0 002.46 11.153 12.532 12.532 0 01-.267-7.213c1.747-6.727 8.616-10.764 15.343-9.017z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M171.53 242.82a19.25 19.25 0 0110.084 6.443c-2.03-5.954-6.916-10.806-13.46-12.505-10.348-2.687-20.915 3.523-23.602 13.87-1.618 6.23-.008 12.536 3.785 17.158a19.265 19.265 0 01-.41-11.097c2.687-10.348 13.255-16.558 23.602-13.87z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M238.826 353.245a19.273 19.273 0 0110.085 6.444c-2.03-5.954-6.915-10.807-13.46-12.506-10.347-2.688-20.914 3.522-23.6 13.87-1.62 6.23-.01 12.536 3.784 17.157a19.261 19.261 0 01-.41-11.096c2.688-10.346 13.255-16.556 23.602-13.87z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M310.462 341.105a19.272 19.272 0 0110.085 6.445c-2.03-5.954-6.916-10.807-13.46-12.506-10.348-2.688-20.914 3.523-23.602 13.87-1.618 6.23-.008 12.536 3.785 17.157a19.257 19.257 0 01-.41-11.095c2.687-10.346 13.254-16.556 23.602-13.87z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M363.542 277.593a11.027 11.027 0 015.772 3.688 11.067 11.067 0 00-7.703-7.156c-5.922-1.537-11.97 2.017-13.507 7.938a11.062 11.062 0 002.166 9.82c-.676-1.98-.8-4.175-.235-6.352 1.537-5.92 7.585-9.475 13.507-7.937z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M225.18 149.162a11.026 11.026 0 015.773 3.688 11.064 11.064 0 00-7.703-7.157c-5.922-1.538-11.97 2.016-13.508 7.938a11.061 11.061 0 002.167 9.82 11.02 11.02 0 01-.236-6.35c1.537-5.922 7.585-9.476 13.507-7.938z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M156.504 167.933a5.786 5.786 0 013.03 1.938 5.82 5.82 0 10-10.002 5.568 5.819 5.819 0 016.97-7.505z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M393.864 247.495a5.786 5.786 0 013.03 1.937 5.813 5.813 0 00-4.045-3.76 5.822 5.822 0 00-7.096 4.17 5.813 5.813 0 001.138 5.158 5.819 5.819 0 016.971-7.506z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M147.554 298.662a5.79 5.79 0 013.03 1.938 5.813 5.813 0 00-4.045-3.76 5.822 5.822 0 00-7.096 4.17 5.809 5.809 0 001.138 5.157 5.794 5.794 0 01-.124-3.335 5.822 5.822 0 017.096-4.17z"
          opacity={0.1}
        />
        <circle
          className={`prefix__hover ${style.hover}`}
        ...
        />
        <path
          d="M189.818 351.455a5.787 5.787 0 013.032 1.938 5.82 5.82 0 10-10.004 5.567 5.82 5.82 0 016.971-7.506z"
          opacity={0.1}
        />
        <path
        ...
        />
        <path
          className={`prefix__stars ${style.stars}`}
          fill="#FFF"
